...
export default function MetricPanel({ hustle }: MetricPanelProps) {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 mb-8">
      {/* Hero card: 예상 월 수익 — full width top */}
      <div className="col-span-2 bg-gradient-to-br from-emerald-50 via-teal-50/60 to-white rounded-2xl border border-emerald-100/80 shadow-[0_2px_16px_rgb(0,0,0,0.04)] p-6">
      ...
      {/* 첫 수입까지 — full width bottom */}
      <div className="col-span-2 bg-white/80 backdrop-blur-sm rounded-2xl border border-black/[0.04] shadow-[0_2px_12px_rgb(0,0,0,0.04)] p-5 flex items-center gap-4">
        <div className="w-11 h-11 flex items-center justify-center rounded-xl bg-violet-50 border border-violet-100 text-xl flex-shrink-0">
          ⏱️
        </div>
        <div>
